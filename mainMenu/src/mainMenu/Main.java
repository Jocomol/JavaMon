...
public class Main extends Application implements Initializable{
	 ...
	 * 
	 * Wir haben Ähnlichen Code nicht immer auskommentiert, wenn es das gleiche bewirkt wie vorher.
	 */
	...
	public void start(Stage primaryStage) throws Exception{
		...
		//stage ist die Primary stage, also kann man die Primary Stage einfach über Stage ansprechen
		...
		SCREEN_WIDTH und SCREEN_HEIHT sind die konstanten Masse des Screens. Könnte auch mit veränderbar gemacht werden,
