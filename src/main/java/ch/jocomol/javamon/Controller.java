...
public class Controller implements Initializable{
	...
	/*
	 * Die Controller Klasse ist der "Controller vom Projekt. �ber sie werden die XML und CSS Komponenten angesprochen."
	 * Sie ist ziemlich gross, und man h�tte auch mehrere Controllerklassen bauen k�nnen, aber das h�tte es viel un�bersichtlicher gemacht.
	 *
	 ...
	 * damit wir eine gute �bersicht haben.
	 */
	...
	static void shuffleArray(Javamon[] mainmons)
	  {
	    //Mischt das Javamon array, so dass immer ein zuf�lliges Starter-Javamon erscheint
